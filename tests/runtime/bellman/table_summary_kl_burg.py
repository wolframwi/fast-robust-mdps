...
def main():
    ...
    print(r"\centering")
    print(r"\caption{KL vs.\ Burg Bellman runtimes (benchmarks, ms).}")
    ...
    for instance in instances:
        ...
        print(
            f"{label} & {fmt_us_to_ms(kl_fast)} & {fmt_us_to_ms(kl_mosek)} & "
            f"{fmt_us_to_ms(burg_fast)} & {fmt_us_to_ms(burg_mosek)} \\\\"
        )
