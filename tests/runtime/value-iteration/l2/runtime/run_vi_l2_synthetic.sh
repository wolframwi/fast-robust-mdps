...
usage() {
  cat <<'EOF'
Usage: run_vi_l2_synthetic.sh <method>

Runs one L2 method over synthetic instances with A=10 and A=S across all ambiguity sets.
...
runner="${script_dir}/run_vi_l2_one.sh"
