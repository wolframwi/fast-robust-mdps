...
usage() {
  cat <<'EOF'
Usage: run_vi_l1_synthetic.sh <method>

Runs one L1 method over synthetic instances with A=10 and A=S across all ambiguity sets.
...
runner="${script_dir}/run_vi_l1_one.sh"
