...
def main():
    ...
    print(r"\centering")
    print(r"\caption{KL vs.\ Burg robust value iteration runtimes (benchmarks, s).}")
    ...
    for instance in instances:
        ...
        kl_fast = median_value(kl_entries, "fast_vi_s", "__fast", "fast_vi_iterations")
        kl_mosek = median_value(kl_entries, "mosek_vi_s", "__mosek", "mosek_vi_iterations")
        burg_fast = median_value(burg_entries, "fast_vi_s", "__fast", "fast_vi_iterations")
        burg_mosek = median_value(burg_entries, "mosek_vi_s", "__mosek", "mosek_vi_iterations")
