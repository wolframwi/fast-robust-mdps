...
usage() {
  cat <<'EOF'
Usage: run_vi_kl_one.sh <instance_dir> <amb_file> <method>

Runs one KL value-iteration method and merges the results into runtime/errors.
...
binary="${runtime_dir}/vi_kl_single"
source="${base_dir}/run_vi_kl_single.cpp"
