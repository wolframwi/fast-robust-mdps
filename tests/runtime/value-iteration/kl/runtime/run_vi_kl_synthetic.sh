...
usage() {
  cat <<'EOF'
Usage: run_vi_kl_synthetic.sh <method>

Runs one KL method over synthetic instances with A=10 and A=S across all ambiguity sets.
...
runner="${script_dir}/run_vi_kl_one.sh"
